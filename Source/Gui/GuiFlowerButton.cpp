...
GuiClearButton::GuiClearButton() : Button("ClearButton")
{
    ...
    m_image1.setTransformToFit(Rectangle<float>(0.f, 0.f, 16.f, 16.f), RectanglePlacement::stretchToFit);
    m_image2.setTransformToFit(Rectangle<float>(0.f, 0.f, 16.f, 16.f), RectanglePlacement::stretchToFit);
    m_image3.setTransformToFit(Rectangle<float>(0.f, 0.f, 16.f, 16.f), RectanglePlacement::stretchToFit);
    m_image1.setOverlayColour(Gui::getColorTxt());
    m_image2.setOverlayColour(Gui::getColorTxt().interpolatedWith(Gui::getColorBg(), 0.5f));
