...
public class audioplugin_CamomileFxGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_CamomileFx"; } }
    public override string Description    { get { return "A plugin that loads Pure Data patches"; } }
    public override string Vendor         { get { return "Pierre Guillot"; } }

    //==============================================================================
    [DllImport("audioplugin_CamomileFx")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_CamomileFx")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_CamomileFx")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_CamomileFx")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_CamomileFx")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_CamomileFx")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_CamomileFx")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
