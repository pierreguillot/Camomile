...
public class audioplugin_CamomileGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_Camomile"; } }
    ...
    //==============================================================================
    [DllImport("audioplugin_Camomile")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_Camomile")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_Camomile")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Camomile")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Camomile")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_Camomile")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_Camomile")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
